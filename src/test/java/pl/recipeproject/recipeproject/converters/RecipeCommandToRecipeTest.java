...
import pl.recipeproject.recipeproject.commands.NotesCommand;
...
public class RecipeCommandToRecipeTest {
    ...
    public static final Difficulity DIFFICULTY = Difficulity.EASY;
    ...
    public void convert() throws Exception {
        ...
        assertEquals(DIFFICULTY, recipe.getDifficulity());
